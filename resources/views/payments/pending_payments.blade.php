        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    @php
                        $url = $type == "sale" ? route("update.pending.receivable.detail", $payment->id) : route("update.pending.payable.detail", $payment->id);
                    @endphp
                    <form id="form-note" method="post" action="{{ $url }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="total_amount" name="total_amount" placeholder="Total Amount" value="{{ $payment->total_amount }}" readonly />
                        </div>

                        <div class="form-group">
                            <label>Amount To Be Paid</label>
                            <input type="text" class="form-control" id="amount_to_pay" value="{{ $payment->amount_remaining + $payment->amount_paid }}" placedholder="Amount To Be Paid" readonly required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="amount_remaining" name="amount_remaining" placeholder="Amount Remaining" 
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function calculate_amount_remaining()
            {
                ...
                var tds_gst = $("#tds_gst").val() || 0;
                if(tds_gst == ''){
                    tds_gst = 0;
                }

                var tcs_income_tax = $("#tcs_income_tax").val() || 0;
                if(tcs_income_tax == ''){
                    tcs_income_tax = 0;
                }

                var tcs_gst = $("#tcs_gst").val() || 0;
                if(tcs_gst == ''){
                    tcs_gst = 0;
                }
