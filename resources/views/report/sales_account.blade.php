...
@section('content')
{!! Breadcrumbs::render('sales-account') !!}
<div class="container">
    <style>
        /* .mainData {
            display: block;
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <form method="post" action="{{ route('export.sale.account') }}">
                                {{ csrf_field() }}
                ...
                <div class="panel-body" id="printable">
					...
					<table class="table table-bordered table-hover" style="margin-bottom:0">
						<thead>
                            <tr>
                                <th width="60%" rowspan="3">Sales Account</th>
                                ...
                                @if( count($combined_array) > 0 )
                                    {{-- <tbody>
                                        <tr>
                                            ...
                                            <td width="10%"></td>
                                            <td width="10%"></td>
                                            <td width="20%">{{ $opening_balance }}</td>
                                        </tr>
                                    </tbody> --}}
                                        ...
                                        <tbody>
                                            <tr class="months" style="background-color: #f1f2fa">
                                                <td width="100%" colspan="4">
                                                    <label for="{{ $key }}" style="text-transform: uppercase; display: block; margin: 0;">{{ $key }}
                                        ...
                                        @foreach( $value as $data )
                                            ...
                                            <tr>
                                                ...
                                                @if($data['transaction_type'] == 'credit_debit')
                                                    ...
                                                    @php $moving_cash += $data['amount_paid'];  $debitTotal += $data['amount_paid']; @endphp
                                                    <td>{{ $data['amount_paid'] }}</td>
                                                    <td></td>
                                                    <td>{{ $data['amount'] }}</td>
                                                @endif
					...
					<table class="table table-bordered table-hover" style="margin-bottom:0">
						<tfoot>
                            <tr>
                                ...
                                <td width="20%">{{ ($closing_total > 0) ? $closing_total .'DR' : $closing_total .'CR' }}</td>
                            </tr>
                        </tfoot>
					</table>
                </div>
