            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <p>Amount Remaining: {{ $invoice->amount_remaining }}</p>
                        </div>
                    </div>
                        ...
                        <tbody>
                            ...
                            @foreach($invoice->items as $item)
                                <tr>
                                    ...
                                    @php $amount += $item->pivot->item_price * $item->pivot->item_qty @endphp
                                    <td>{{ $item->pivot->item_price * $item->pivot->item_qty }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                        <tfoot>
