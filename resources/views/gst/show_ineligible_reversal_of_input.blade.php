                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th>
                                    @if( app('request')->input('fix_date'))
                                        @php
                                            $fix_date = app('request')->input('fix_date');
                                        @endphp
                                    @else
                                        @php
                                            $fix_date = \Carbon\Carbon::now()->format('d/m/Y');
                                        @endphp
                                    @endif
                        ...
                        <tbody>
                            <form method="POST" action="{{ route('post.gst.reversal.of.input') }}">
                                ...
                                <tr>
                                    <th>CGST</th>
                                    <td><input type="text" class="form-control" name="itc_cgst" readonly value="{{ $input->itc_cgst ?? 0 }}" /></td>
                                    <td><input type="text" class="form-control" name="reverse_cgst" id="reverse_cgst" readonly value="{{ $input->reverse_cgst ?? 0 }}" ></td>
                                    <td><input type="text" class="form-control" name="ineligible_cgst" id="ineligible_cgst" readonly value="{{ $input->ineligible_cgst ?? 0 }}" ></td>
                                </tr>
                                <tr>
                                    <th>SGST</th>
                                    <td><input type="text" class="form-control" name="itc_sgst" readonly value="{{ $input->itc_sgst ?? 0 }}" /></td>
                                    <td><input type="text" class="form-control" name="reverse_sgst" id="reverse_sgst" readonly value="{{ $input->reverse_sgst ?? 0 }}" ></td>
                                    <td><input type="text" class="form-control" name="ineligible_sgst" id="ineligible_sgst" readonly value="{{ $input->ineligible_sgst ?? 0 }}"></td>
                                </tr>
                                <tr>
                                    <th>IGST</th>
                                    <td><input type="text" class="form-control" name="itc_igst" readonly value="{{ $input->itc_igst ?? 0 }}" /></td>
                                    <td><input type="text" class="form-control" name="reverse_igst" id="reverse_igst" readonly value="{{ $input->reverse_igst ?? 0 }}" ></td>
                                    <td><input type="text" class="form-control" name="ineligible_igst" id="ineligible_igst" readonly value="{{ $input->ineligible_igst ?? 0 }}" ></td>
                                </tr>
                                <tr>
                                    <th>CESS</th>
                                    <td><input type="text" class="form-control" name="itc_cess" readonly value="{{ $input->itc_cess ?? 0 }}" /></td>
                                    <td><input type="text" class="form-control" name="reverse_cess" id="reverse_cess" readonly value="{{ $input->reverse_cess ?? 0 }}" ></td>
                                    <td><input type="text" class="form-control" name="ineligible_cess" id="ineligible_cess" readonly value="{{ $input->ineligible_cess ?? 0 }}" ></td>
                                </tr>
                                <tr>
                                    <th>Total</th>
                                    <td><input type="text" class="form-control" name="itc_total" readonly value="{{ $input->itc_total ?? 0 }}" ></td>
                                    <td><input type="text" class="form-control" name="reverse_total" id="reverse_total" readonly value="{{ $input->reverse_total ?? 0 }}" ></td>
                                    <td><input type="text" class="form-control" name="ineligible_total" id="ineligible_total" readonly value="{{ $input->ineligible_total ?? 0 }}" ></td>
                                </tr>
                                {{-- <tr>
                                    <th>Narration</th>
                                    <td></td>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <textarea class="form-control" rows="1" name="narration" placeholder="Narration" readonly>{{ $input->narration ?? '' }}</textarea>
                                    </td>
                                    <td><input type="text" class="form-control custom_date" placeholder="DD/MM/YYYY" name="submit_date" value="{{ isset($input->submit_date) ? \Carbon\Carbon::parse($input->submit_date)->format('d/m/Y') : '' }}" readonly /></td>
                                    <td>
