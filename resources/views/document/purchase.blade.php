    ...
    <div id="mydraggable" style="width: 95%; height: 90%; background-color: #333; position: absolute; z-index: 99999; padding-left: 20px; padding-right: 20px; border: 1px solid #ccc; box-sizing: border-box; margin: 0 auto; overflow: hidden; display: none;">
        ...
        <div style="width: 90%; margin: 0 auto; clear: both;">
            <div class="row text-left" style="position: relative;">
                    <button type="button" id="prevImage" class="btn btn-info" data-info="">Prev</button>
                ...
                {{-- </div> --}}
                    <button type="button" id="nextImage" class="btn btn-info" data-info="">Next</button>
            </div>
        </div>
    </div>
@endsection
...
{!! Breadcrumbs::render('purchase-document') !!}

{{-- <div id="mydraggable" style="height: 500px; width: 500px; background-repeat: no-repeat; background-size: 100% 100%; border: 1px solid #ccc; display: none; z-index: 99999; position: absolute;">
...
<div id="container" class="container">
    {{-- <p>
        <button id="btn-display-iframe" class="btn btn-success">Open Purchase Form</button>
    </p> --}}
    <div id="document">
        <div class="row" style="margin-bottom: 20px;">
            <form method="GET" action="{{ route('purchase.document') }}">
                <div class="col-md-5">
    ...
    {{-- <div id="form" style="display: none; padding: 20px 0;">
        <p><button id="btn-hide-iframe" class="btn btn-danger">Close Purchase Form</button></p>
    ...
    <script>
        ...
        $(document).ready(function () {
            $(".view-full").on("click", function () {
                ...
                $("#prevImage").attr("data-info", row);
                $("#nextImage").attr("data-info", row);
            ...
            $("#prevImage").on("click", function() {
                ...
                const prevTr = $("tbody").find(`[data-row='${dataInfo}']`).prev();

                prevTr.find(".view-full").trigger("click");
            });

            $("#nextImage").on("click", function() {
                const dataInfo = $(this).attr("data-info");
                const nextTr = $("tbody").find(`[data-row='${dataInfo}']`).next();

                nextTr.find(".view-full").trigger("click");
            });
