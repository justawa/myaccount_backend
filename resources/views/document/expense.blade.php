...
@section('draggable')
    <div id="mydraggable" style="width: 95%; height: 60%; background-color: #333; position: absolute; z-index: 99999; padding-left: 20px; padding-right: 20px; border: 1px solid #ccc; box-sizing: border-box; overflow: hidden; display: none;">
        ...
        <div style="width: 100%; clear: both;">
            <div class="row text-center" style="position: relative;">
                <div class="col-md-3 text-center"><button type="button" id="change_row_status" data-row="" class="btn btn-success">Mark as done</button></div>
                <div class="col-md-3 text-center"><button type="button" id="rotate-draggable" class="btn btn-primary">Rotate Image</button></div>
                <div class="col-md-2 text-center"><button type="button" onclick="zoomin()" class="btn btn-primary">Zoom In</button></div>
                <div class="col-md-2 text-center"><button type="button" onclick="zoomout()" class="btn btn-primary">Zoom Out</button></div>
                <div class="col-md-2 text-center"><button type="button" id="close-draggable" class="btn btn-danger">Close</button></div>
            </div>
        </div>
    </div>
@endsection
        ...
        <tbody>
            @if( count($uploaded_statements) > 0 )
                ...
                <tr>
                    ...
                    <td><button type="button" class="btn btn-link view-full" data-row="{{ $bill->id }}" data-src="{{ $image_path }}" data-is_image="{{ $isImage }}">View Full</button></td>
                </tr>
                @endforeach
            @else
                <tr>
