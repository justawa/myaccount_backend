...
@section('content')
{!! Breadcrumbs::render('create-purchase-order') !!}
<div class="container">
    @if (session('success'))
    ...
    @endif
    <form method="POST" action="{{ route('store.purchase.order') }}" id="create-purchase-order">
    {{ csrf_field() }}
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control custom_date" placeholder="DD/MM/YYYY" id="purchase_order_date" name="purchase_order_date" required />
        ...
        <div class="col-md-3">
            ...
            <div class="form-group {{ $showErrors ? ' has-error' : '' }}">
                ...
                <input type="text" class="form-control" id="purchase_token" name="purchase_token" @if ( $myerrors->has('token_no') ) required @else @if($errors->has('token_no')) {{-- readonly value="{{ $invoice_no + 1 }}" --}} @else @if(isset(auth()->user()->purchaseOrderSetting) && auth()->user()->purchaseOrderSetting->bill_no_type == 'auto') value="{{ $order_no + 1 }}" readonly @endif @endif @endif required />
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" id="amount_paid" name="amount_paid" placeholder="Amount Paid" />
                        </div>
                    </div>
                </div>
            </div>
...
@section('scripts')
    <script>
        ...
        $(document).ready(function (){
            ...
            $("#purchase_token").on("keyup", function() {
                var bill_no = $("#purchase_token").val() ? $("#purchase_token").val() : undefined;
            ...
            function validateBillNo(party = undefined, bill_no = undefined, userId = undefined) {
                ...
                if(party && bill_no && userId){
                    $.ajax({
                        type: 'post',
                        url: "{{ route('api.validate.purchaseorderno') }}",
                        data: {
                            "token": bill_no,
                            "party": party,
                            "user": userId
            ...
            function validateOrderForm(e) {
                ...
                if(validation) {
                    // $("#create-purchase-order").trigger( "submit" );
