...
{!! Breadcrumbs::render('edit-purchase-party-pending-payment', request()->segment(3)) !!}
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form method="POST" action="{{ route('update.purchase.party.pending.payment', $party_pending_payment->id) }}">
                        {{ csrf_field() }}
                        {{ method_field('PUT') }}
                        <div style="padding: 10px 0; width: 100%; display: inline-block;">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="voucher_no" placeholder="Voucher No." value="{{ $party_pending_payment->voucher_no }}" @if(isset(auth()->user()->paymentSetting) && auth()->user()->paymentSetting->bill_no_type == 'auto') readonly @endif>
                            </div>
                        </div>
                        <table class="table">
                            <thead>
                    ...
                    <form id="cancel-payment-form" method="POST" action="{{ route('cancel.purchase.party.payment', $party_pending_payment->id) }}">
                        {{ csrf_field() }}
                        {{ method_field('PUT') }}
                    </form>
                </div>
