    ...
    <form method="post" action="#">
        ...
        <div class="container" id="printable">
            ...
            <div class="row" style="margin-bottom: 20px;">
                ...
                <div class="col-md-6">
                    <a href="{{ route('purchase.debit.note.edit', $note_no) }}">Edit Note</a>
                </div>
            </div>
            <div class="row" style="margin-bottom: 20px;">
                <div class="col-md-6">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        @if(count($debit_notes) > 0)
                            ...
                            <tr>
                                ...
                                <td>@if(auth()->user()->profile->inventory_type != "without_inventory") {{ $debit_note->original_qty ?? 0 }} @endif</td>
                                <td>{{ $debit_note->original_unit }}</td>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th colspan="3">{{ $debit_notes->first()->reason }}</th>
                        </tr>
                        <tr>
