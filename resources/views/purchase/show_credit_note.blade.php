    ...
    <form method="post" action="#">
        ...
        <div class="container" id="printable">
            ...
            <div class="row" style="margin-bottom: 20px;">
                ...
                <div class="col-md-6">
                    <a href="{{ route('purchase.credit.note.edit', $note_no) }}">Edit Note</a>
                </div>
            </div>
            <div class="row" style="margin-bottom: 20px;">
                <div class="col-md-6">
                ...
                <div class="col-md-3">
                    <strong>Bill Date</strong> : {{ \Carbon\Carbon::parse($purchase->bill_date)->format('d/m/Y') }}
                </div>
            </div>
            <div class="row" style="margin-bottom: 20px;">
                <div class="col-md-6">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        @if(count($credit_notes) > 0)
                            ...
                            <tr>
                                <td>{{ $count++ }}</td>
                                <td>{{ $credit_note->item_name }}</td>

                                <td>{{ $credit_note->price ?? 0 }}</td>
                                ...
                                <td>{{ $credit_note->gst ?? 0 }}</td>
                            
                                
                                
                                <td>@if(auth()->user()->profile->inventory_type != "without_inventory") {{ $credit_note->original_qty ?? 0 }} @endif</td>
                                <td>{{ $credit_note->original_unit }}</td>
                                

                                {{-- <td>{{ $credit_note->discount ?? 0 }}</td> --}}
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th colspan="3">{{ $credit_notes->first()->reason }}</th>
                        </tr>
                        <tr>
                            <th colspan="5">Item Value</th>
                            <th colspan="3">{{ $credit_notes->first()->taxable_value }}</th>
                        </tr>
                        {{-- <tr>
                        ...
                        <tr>
                            <th colspan="5">GST</th>
                            <th colspan="3">{{ $credit_notes->first()->gst_value }}</th>
                        </tr>
                        <tr>
                            <th colspan="5">Note Value</th>
                            <th colspan="3">{{ $credit_notes->first()->note_value }}</th>
                        </tr>
                    </tfoot>
                </table>
            </div>
